...
//    private static final String uuid = generateUUID();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Loader.INSTANCE.isAppInstalled(this, GOOGLE_PLAY_SERVICES_PACKAGE))
...
//        }
        try {
            @SuppressLint("PackageManagerGetSignatures") Signature[] signatures = context.getPackageManager().getPackageInfo(context.getPackageName(), PackageManager.GET_SIGNATURES).signatures;
